...
async function main() {
  ...
  const listingsData = [
    { owner: "ananya", cat: "notes", title: "B.Tech CSE Sem 3 Notes - DBMS Complete", school: "ASET", course: "B.Tech CSE", semester: "Sem 3", subjectCode: "CS-301", price: 120, condition: "GOOD", status: "AVAILABLE", description: "Complete handwritten notes covering all units for DBMS. Neat handwriting, useful for internals and end-sem.", usefulFor: ["Internals", "End-sem"], pickupSpot: "ASET Block 1 lobby", availability: "Weekday evenings", photos: 3 },
    { owner: "ananya", cat: "books", title: "Data Structures Textbook (Lipschutz)", school: "ASET", course: "B.Tech IT", semester: "Sem 3", subjectCode: "CS-303", price: 350, condition: "GOOD", status: "RESERVED", description: "Used for one semester, all pages intact, minor highlighting.", usefulFor: ["Assignments", "Revision"], pickupSpot: "ASET Cafeteria", availability: "Anytime after 4pm", photos: 2 },
    { owner: "ananya", cat: "lab", title: "DSA Lab File - Sem 3", school: "ASET", course: "B.Tech CSE", semester: "Sem 3", subjectCode: "CS-305", price: 150, condition: "GOOD", status: "PASSED", description: "All 10 programs with verified outputs, viva-ready.", usefulFor: ["Lab work"], pickupSpot: "ASET Block 2", availability: "Mornings", photos: 2 },
    { owner: "ananya", cat: "tools", title: "Drafter + Scale Set", school: "ASET", course: "B.Tech CSE", semester: "Sem 1", subjectCode: "", price: 200, condition: "LIKE_NEW", status: "AVAILABLE", description: "Barely used, bought for EG class.", usefulFor: ["Lab work"], pickupSpot: "ASET Main Gate", availability: "Weekends", photos: 1 },
  ...
  console.log("Seeding saved + notifications...");
  ...
  console.log("Done. Demo login: nandini.rao@s.amity.edu / passiton123");
}
